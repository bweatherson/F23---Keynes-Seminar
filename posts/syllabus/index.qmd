...
Students must read the listed readings before Monday's class session. Important: class readings are subject to change, contingent on circumstances and the progress we make as a class. Students are encouraged to attend lectures and check the course website for updates. The links to readings will often be to things behind paywalls, but they are (I believe) all things you have access to through the UM library. You might have to be logged in to UM to get them though.
